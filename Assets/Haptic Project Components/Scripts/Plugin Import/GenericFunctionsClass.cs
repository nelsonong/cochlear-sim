...
public class GenericFunctionsClass : MonoBehaviour {
	...
	private double[] myProxyPosition = new double[1];
	private double[] myProxyRight = new double[1];
	private double[] myProxyDirection = new double[1];
	private double[] myProxyTorque = new double[1];
